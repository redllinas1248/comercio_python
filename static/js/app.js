  ...
  return `
    <div class="card ${p.destacada ? 'card-destacada' : ''}" id="pub-${pid}">
      ...
      <div class="card-acciones">
        ...
        <button class="btn-accion btn-wa" onclick="contactarWA('${ptel}', ${pid}, encodeURIComponent(p.contenido.slice(0,60)))">
...
/* ===== WhatsApp ===== */
function contactarWA(telefono, pubId, descripcionCod) {
  const descripcion = decodeURIComponent(descripcionCod);
